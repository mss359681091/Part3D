...
namespace _3DPart.DAL.BULayer
{
    public class SQLHelper
    {
        ...
        public static DataTable GetTable(string strSQL, Hashtable pas)
        {
        ...
        public static DataTable GetTable(string strSQL, Hashtable pas, CommandType cmdtype)
        {
        ...
        public static DataSet GetDataSet(string strSQL, Hashtable pas)
        {
        ...
        public static DataSet GetDataSet(string strSQL, Hashtable pas, CommandType cmdtype)
        {
        ...
        public static int ExcuteProc(string ProcName, Hashtable pas)
        {
        ...
        public static int ExcuteSQL(string strSQL, Hashtable pas)
        {
        ...
        public static int ExcuteSQL(string strSQL, Hashtable pas, CommandType cmdType)
        {
            int i = 0;
            using (SqlConnection conn = new SqlConnection(strConn))
            {
        ...
        /// <returns></returns>
        public static object GetObjectByProc(string ProcName, Hashtable pas)
        {
        ...
        /// <param name="pas"></param>
        /// <returns></returns>
        public static object GetObject(string strSQL, Hashtable pas)
        {
        ...
        public static object GetObject(string strSQL, Hashtable pas, CommandType cmdtype)
        {
            object o = null;
            using (SqlConnection conn = new SqlConnection(strConn))
            {
        ...
        /// <param name="pas">参数数组</param>
        /// <returns>DataReader对象</returns>
        public static SqlDataReader GetReaderByProc(string procName, Hashtable pas)
        {
        ...
        /// <param name="pas">参数数组</param>
        /// <returns>DataReader对象</returns>
        public static SqlDataReader GetReader(string strSQL, Hashtable pas)
        {
        ...
        public static SqlDataReader GetReader(string strSQL, Hashtable pas, CommandType cmdtype)
        {
